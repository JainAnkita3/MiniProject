...
public class ServiceImpl extends EcommerceUtil {
	...
	public static void main(String[] args) {
		...
		String prodQuantity = "2";
		BigDecimal totalCartProdPrice1 = cartDao.getCartProdTotalPrice(product5.getSellingPrice(), prodQuantity);
		System.out.println("fjh : " + totalCartProdPrice1);

		// TODO Future use for total amount payable by customer to put in Cart
		BigDecimal totalCartProdPrice = new BigDecimal("0.0");
		//totalCartProdPrice = new BigDecimal(totalCartProdPrice1 + totalCartProdPrice);
		...
		Orders custOrder = new Orders(cart, customer, new java.util.Date(), prodQuantity, totalCartProdPrice1,
				totalCartProdPrice);
